...
file_put_contents( '/tmp/3.log', var_export($pr,true),FILE_APPEND);

$cntnt = file_get_contents($pr['result']);
$jdata = json_decode($cntnt);
...
switch((int)$jdata->{'stat'}){ 
case 1:
   echo "SUCCESS (".$jdata->{'data'}->{'flag'}.")";
   break;
